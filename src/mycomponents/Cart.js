...
<div className='sm:hidden md:flex justify-around bg-[#2E0052] text-white'>
            ...
            <div className='flex ml-12 mt-5'>
                ...
                <p className='pt-2'>Home / Sony WH-CH720N</p><br/>
            </div>
            <div className='flex ml-12 mt-8'>
        <Link to='/'> <button className='bg-[#2E0052] text-white p-2 rounded-lg'>Back to products</button></Link>
        </div>
        <div className='flex ml-12 mt-9'>
        <h1 className='font-bold text-2xl'>Sony WH-CH720N, Wireless Over-Ear Active Noise Cancellation Headphones with Mic, up to 50 Hours<br/> Playtime, Multi-Point Connection, App Support, AUX & Voice Assistant Support for Mobile Phones <br/>(Black)</h1>
        </div>
        <div className='flex justify-between'>
            <div>
                <img src={head} alt="" className='border-solid border-4 border-black p-24 ml-10 rounded-2xl'/>
            </div>
            <div>
                ...
                <ul>
                    ...
                    <li>Up to 50-hour battery life with quick charging (3 min charge for up to 1 hour playback)</li>
                    <li>Multi-Point Connection helps to pair with two Bluetooth devices at the same time</li>
                    <li>Take noise cancelling to the next level with Sony’s Integrated Processor V1,so you fully immerse yourself in the music</li>
